...
MIDDLEWARE = [
    ...
    'students.middleware.Custom404MessageDisplayMiddleWare',
...
SIMPLE_JWT = {
    ...
    "ON_LOGIN_FAILED": (
        "rest_framework_simplejwt.serializers.default_on_login_failed"
    ),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LESA Academy API',
    'DESCRIPTION': 'Management system for students and teachers.',
    'VERSION': '1.0.0',
