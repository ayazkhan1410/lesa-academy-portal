...
const Login = ({ onLogin }) => {
    ...
    return (
        <div className={`relative min-h-screen transition-colors duration-700 ease-in-out flex items-center justify-center overflow-hidden font-sans ${isDark ? 'bg-[#020617] text-slate-200' : 'bg-slate-50 text-slate-800'}`}>
                ...
                <div className={`relative h-full backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-10 border shadow-2xl transition-all duration-700 ${isDark ? 'bg-[#0f172a]/80 border-white/5 shadow-black/80' : 'bg-white/60 border-white/40 shadow-blue-200/50'}`}>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        >
                            ...
                            <div className={`relative rounded-2xl border shadow-inner transition-colors duration-700 overflow-hidden w-20 h-20 ${isDark ? 'border-white/10' : 'border-white/50'}`}>
            ...
            <div className={`absolute bottom-6 flex flex-col items-center gap-1 transition-opacity ${isDark ? 'opacity-40 hover:opacity-100' : 'opacity-60 hover:opacity-100'}`}>
                ...
                <p className={`text-[9px] font-mono uppercase tracking-widest ${isDark ? 'text-slate-500' : 'text-slate-500'}`}>Secure Admin Portal</p>
            </div>
